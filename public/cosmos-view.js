...
export function mountCosmos(root,api){
  ...
  function refresh(force=false){
    ...
    root.innerHTML=`<div class="cosmos-workshop"><div class="cosmos-heading"><span class="eyebrow">THE CELESTIAL ATELIER</span><h2>As above, a world below.</h2><p>The sky has a voice. Give it a place in your hands.</p></div>
      ${api.astral?'<section class="astral-launch"><h3>Your body rests. Your spirit travels.</h3><p>Visit the Sun, planets, moons and asteroids. Enter their landscapes and bring a Luma memory home.</p><button data-astral-launch>Begin astral travel ↗</button></section>':''}
    ...
    $('[data-astral-launch]')?.addEventListener('click',()=>api.astral());
